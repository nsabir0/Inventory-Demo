...
//									edtScanQty.removeTextChangedListener(mQuantityTextWatcher);
        ...
        chkScanMultiQty.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    // request focus
					/*final InputMethodManager inputMethodManager = (InputMethodManager) ScanActivity.this.getSystemService(Context.INPUT_METHOD_SERVICE);
					inputMethodManager.showSoftInput(edtMultiQty, InputMethodManager.SHOW_IMPLICIT);*/
//					edtMultiQty.requestFocus();
                } else {
        ...
        edtItemCode.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            @Override
        ...
        edtScanQty.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            @Override
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
...
//					processForSaveItem();
        ...
        btnViewAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ScanActivity.this, ViewScanItems.class));
            }
        });
    }
            ...
            public void run() {
                try {
                    if (item != null) {
                        ...
                        tvMrp.setText(String.format("%.2f", item.unitPrice));
        ...
        for (int i = 0; i < saveInventoryList.size(); i++) {
            ...
            StringRequest strReq = new StringRequest(Request.Method.POST, url, response -> {
                ...
                protected Map<String, String> getParams() {
                    ...
                    header.put("SalePrice", String.valueOf(saveInventoryList.get(finalI).salePrice));
